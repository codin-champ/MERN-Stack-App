...
const onPlaceOrder = (user) => {
  if (user) {
    localStorage.setItem("FName", user.name);
    localStorage.setItem("FShop", user.shop);
    localStorage.setItem("FVeg", user.vegnveg);
    localStorage.setItem("FPrice", user.price);
    localStorage.setItem("FRating", user.rating);
                ...
                {users.map((user, ind) => (
                  <TableRow key={ind}>
                    ...
                    <TableCell>
                      <Button
                        variant="contained"
                        onClick={(event) => onPlaceOrder(user)}
                      >
                        Place Order
                      </Button>
                    </TableCell>
